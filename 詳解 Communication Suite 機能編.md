...
2  | SpeechVisualizer - ホーム | ホーム画面のレイアウト (配置情報)  | 2-2-2 参照 | ガジェット名と設定項目をもとに配置情報を指定 |  
3   | SpeechVisualizer - ホーム   | ホームモジュールの自動再読込間隔  | 600000 |各ホームモジュールが自動で再読込を行う場合の間隔の設定。単位は「ミリ秒」、有効値「1以上の整数」を指定 |
...
- ホーム画面のガジェット配置を設定できます。
	...
	```
	表示したい列を`;`で区切り、列内のガジェット名を`,`で区切りで記述します。
	...
	システム全体のレイアウト設定は詳細設定内で設定します。以下はデフォルトの設定内容です。




	[@fig:home_defaultlayout] はデフォルト設定の状態で初回ログインしたユーザのガジェットレイアウトです。

	![デフォルト設定のホーム画面レイアウト](images/home_defaultlayout.png){#fig:home_defaultlayout width=700px}


	![](images/NOTICE.png){width=50px}
	『ホーム画面のレイアウト (配置情報)』の設定で配置の対象となるのは『ホームモジュールのプロバイダ』で設定した『プロバイダ』のガジェットのみです。『プロバイダ』に追加済みでも『マイクエリ』ガジェットは SpeechVisualizer のマイクエリ機能、『通話スコアリング』、『通話品質評価テンプレート』、『スキル』のガジェットについてはそれぞれ ControlCenter で設定済みの場合のみ表示されます。

	![](images/Tips.jpg){width=50px}　『ホーム画面のレイアウト (配置情報)』はシステム全体のデフォルト設定とユーザごとの個人設定が有ります。ユーザがホーム画面の設定・レイアウト変更を行うまでは、デフォルト設定が適用されます。設定・レイアウト変更を行った際に、ユーザごとの個人設定が作成され、個人設定の内容が優先されるようになります。
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。リンクガジェットはガジェット名以外の設定項目を持ちません。

		```
		Link
		```

		![リンクガジェットと設定項目](images/home_link.png){#fig:home_link width=400px}


		No. | 設定項目      | デフォルトの設定 |設定内容
		---:|------|------------------|-  |   
		1  |ガジェット名   | Link  | リンクガジェットを配置する  |  

		:リンクガジェットの書式説明 {#tbl:svhomelink}

 	1. お知らせ  
ControlCenterで登録したお知らせの設定です 。ログインしているユーザの所属プロジェクトによって表示する項目がコントロール可能です。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		Announcement:"表示件数の選択":"既読のお知らせの表示"
		```

		[@fig:home_info] はお知らせガジェット、[@tbl:svhomeinfo] はレイアウト配置設定項目です。


		![お知らせガジェットと設定項目](images/home_info.png){#fig:home_info width=500px}


		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | Announcement  | お知らせガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |既読のお知らせの表示   | 0  |0:表示しない,1:表示する   |   
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		```
		MyRecent:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"設定なし":"感情解析結果の表示"
		```
		[@fig:home_myrecent] は自分の通話ガジェット、[@tbl:svhomemyrecent] はレイアウト配置設定項目です。

		![自分の通話ガジェットと設定項目](images/home_myrecent.png){#fig:home_myrecent width=500px}


		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | MyRecent | 自分の通話ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |   
		4   |設定なし   |   |【要確認】  
		5   |設定なし   |   |【要確認】    
		6   |設定なし   |   |【要確認】
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:自分の通話ガジェットの書式説明 {#tbl:svhomemyrecent}



 	1. 自分の通話(IN)  
ログインしているユーザの着信した通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		MyRecentInbound:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"設定なし":"感情解析結果の表示"
		```

		[@fig:home_myrecentinbound] は自分の通話(IN)ガジェット、[@tbl:svhomemyrecentinbound] はレイアウト配置設定項目です。


		![自分の通話(IN)ガジェットと設定項目](images/home_myrecentinbound.png){#fig:home_myrecentinbound width=400px}

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | MyRecentInbound | 自分の通話(IN)ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |   
		4   |設定なし   |   |【要確認】  
		5   |設定なし   |   |【要確認】    
 	...
 	1. 自分の通話(OUT)  
ログインしているユーザの発信した通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		MyRecentOutbound:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"設定なし":"感情解析結果の表示"
		```

		[@fig:home_myrecentoutbound] は自分の通話(OUT)ガジェット、[@tbl:svhomemyrecentoutbound] はレイアウト配置設定項目です。

		![自分の通話(IN)ガジェットと設定項目](images/home_myrecentoutbound.png){#fig:home_myrecentoutbound width=400px}

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | MyRecentOutbound | 自分の通話(OUT)ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |   
		4   |設定なし   |   |【要確認】  
		5   |設定なし   |   |【要確認】    
 	...
 	1. 所属プロジェクトの通話  
 ログインしているユーザが所属しているプロジェクトの通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		ProjectRecent:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomeprojectrecent] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | ProjectRecent | 所属プロジェクトの通話ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |   
		4   |設定なし   |   |【要確認】    
		5   |設定なし   |   |【要確認】
		6  |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示   |  
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:所属プロジェクトの通話ガジェットの書式説明 {#tbl:svhomeprojectrecent}


 	1. .所属プロジェクトの通話(IN)  
ログインしているユーザが所属しているプロジェクトの着信通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		ProjectRecentInbound:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomeprojectrecentInbound] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | ProjectRecentInbound | 所属プロジェクトの通話(IN)ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |   
		4   |設定なし   |   |【要確認】    
		5   |設定なし   |   |【要確認】
 	...
 	1. 所属プロジェクトの通話(OUT)  
ログインしているユーザが所属しているプロジェクトの発信通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		ProjectRecentOutbound:"表示件数の選択":"自動更新の有効化:"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomeprojectrecentoutbound] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | ProjectRecentOutbound | 所属プロジェクトの通話(OUT)ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |   
		4   |設定なし   |   |【要確認】    
		5   |設定なし   |   |【要確認】
 	...
 	1. 自分が最近再生した通話  
ログインしているユーザが音声再生を実施した通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		MyRecentPlayHistory:"表示件数の選択":"自動更新の有効化:"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomemyrecentplayhistory] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | MyRecentPlayHistory | 自分が最近再生した通話ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		4   |設定なし   |   |【要確認】    
		5   |設定なし   |   |【要確認】
		...
		![](images/Tips.jpg){width=50px}　通話の再生は、ホーム画面・通話検索画面の簡易プレーヤーでの再生もしくは通話詳細画面での再生が該当します。

 	1. 自分が最近参照した通話  
ログインしているユーザが通話詳細画面を参照した通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		MyRecentViewHistory:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
	[@tbl:svhomemyrecentviewhistory] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | MyRecentViewHistory | 自分が最近参照した通話ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |    
		4   |設定なし   |   |【要確認】    
		5   |設定なし   |   |【要確認】
 	...
 	1. 自分が最近編集した通話  
 ログインしているユーザが通話詳細画面で認識テキストを編集した通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		MyRecentEditHistory:"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomemyrecentedithistory] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | MyRecentEditHistory | 自分が最近編集した通話ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		4   |設定なし   |   |【要確認】    
		5   |設定なし   |   |【要確認】
 	...
 	1. 自分の通話に対する最近のコメント  
ログインしているユーザの通話に対して評価・コメントがされている通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		RecentComment:"表示件数の選択":"自動更新の有効化":"設定なし"
		```
		[@tbl:svhomerecentcomment] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | RecentComment | 自分の通話に対する最近のコメントガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		4   |設定なし   ||【要確認】|   
 	...
 	1. 自分が最近投稿したコメント  
ログインしているユーザが評価・コメントした通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		RecentPostComment:"表示件数の選択":"自動更新の有効化":"カラム表示設定"
		```
		[@tbl:svhomerecentpostcomment] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | RecentPostComment | 自分が最近参照した通話ガジェットを配置する  |  
		2   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		4   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |   
		:自分が最近参照した通話ガジェットの書式説明 {#tbl:svhomerecentpostcomment}

 	1. お気に入り  
ログインしているユーザがお気に入り設定した通話一覧です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		Favorite:"自動更新の有効化":"カラム表示設定"
		```
		[@tbl:svhomefavorite] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | Favorite | お気に入りガジェットを配置する  |  
		2   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |   
		3  |感情解析結果の表示   | 1  |0:表示しない,1:表示する    |  
		:お気に入りガジェットの書式説明 {#tbl:svhomefavorite}

 	1. 評価の遷移  
ログインしているユーザの通話の評価の推移です 。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		RatingCurve:"表示するX軸スケール(数値)":"表示するX軸スケール(単位)":"ガジェットの大きさ""
		```
		[@tbl:svhomeratingcurve] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | RatingCurve | 評価の遷移ガジェットを配置する  |  
		2   |表示するX軸スケール(数値)   |6|UIで選択した場合は5,6,7,10,12,14のいずれかになります。詳細設定では任意の数字を指定が可能 |   
		3  |表示するX軸スケール(単位)   | M  |D:日,W:週,M:月    |  
		4  |  ガジェットの大きさ | 1  |1:狭い,2:普通,3:広い   |  
		:評価の遷移ガジェットの書式説明 {#tbl:svhomeratingcurve}

		![](images/Tips.jpg){width=50px}　『評価の遷移』で扱う「評価点数」は通話詳細から通話に対してコメントをつける際に設定できる点数(星の数)です。グラフにはX軸スケール単位内の(評価点数合計 ÷ 評価件数)で算出される1.0～5.0までの評価点数の平均値が表示されます。

 	1. 感情の遷移  
ユーザの感情の推移です 。確認したいユーザを選択して表示します。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		emotionCurve:"表示する横軸スケール(数値)":"表示する横軸スケール(単位)":"自動更新の有効化":"ユーザID"%2C"ユーザID"%2C・・・
		```
		[@tbl:svhomeratingcurve] はレイアウト配置設定項目です。

		No. | 設定項目      | デフォルトの設定 |設定内容|
		---:|------|------------------|-  |   
		1  |ガジェット名   | emotionCurve | 評価の遷移ガジェットを配置する。  |  
		2   |表示する横軸スケール(数値)   |6|UIで選択した場合は12,14のどちらかになります。詳細設定では任意の数字で指定が可能 |   
		3  |表示する横軸スケール(単位)   | H  |H:時,D:日    |  
		4  |自動更新の有効化   | 0  |0:無効化,1:有効化    |  
		5  |ユーザID   |   |感情の推移を確認したいユーザのIDを記載する。複数ユーザを設定する場合には、ユーザIDの間に%2Cと記載する。   |  
		:感情の遷移ガジェットの書式説明 {#tbl:svhomeemotioncurve}

 	1. マイクエリ  
ユーザが設定したマイクエリの検索結果一覧です。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		MyQuery-"マイクエリ番号":"表示件数の選択":"自動更新の有効化":"設定なし":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomemyquery] はレイアウト配置設定項目です。

	 No. | 設定項目      | デフォルトの設定 |設定内容|
	 ---:|------|------------------|-  |    
		1  |ガジェット名   | MyQuery | マイクエリガジェットを配置する  |  
		2  |マイクエリ番号   |   | ユーザで作成したマイクエリに割り当てられる番号です。1から作成した数だけ存在します。  |   
		3   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		4  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		5   |設定なし   |   |【要確認】    
		6   |設定なし   |   |【要確認】
		7   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |  
		8  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |  
	:マイクエリガジェットの書式説明 {#tbl:svhomemyquery}

 	1. 通話スコアリング  
ControlCenterで設定した通話スコアリングの適用通話一覧です。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		Score-"通話スコアリング番号":"表示件数の選択":"自動更新の有効化":"対象期間":"設定なし":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomescore] はレイアウト配置設定項目です。

		 No. | 設定項目      | デフォルトの設定 |設定内容|
		 ---:|------|------------------|-  |    
		1  |ガジェット名   | Score | 通話スコアリングガジェットを配置する  |  
		2  |通話スコアリング番号   |   | ControlCenterで作成した通話スコアリングに割り当てられる番号です。1から作成した数だけ存在します。  |   
		3   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		4  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		5   |対象期間   | 1  |UI上は今日のみ(1) 、昨日から(2)、過去7日（7）のみ。詳細設定では任意の数字で指定が可能   
		6   |設定なし   |   |【要確認】
		7   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |  
		8  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |  
 	...
 	1. 通話品質評価テンプレート  
ControlCenterで設定した通話品質評価テンプレートの適用通話一覧です。
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。

		```
		QualityEvaluation-"通話品質評価テンプレート番号":"表示件数の選択":"自動更新の有効化":"対象期間":"ソート条件":"カラム表示設定":"感情解析結果の表示"
		```
		[@tbl:svhomequalityevaluation] はレイアウト配置設定項目です。

		 No. | 設定項目      | デフォルトの設定 |設定内容|
		 ---:|------|------------------|-  |    
		1  |ガジェット名   | QualityEvaluation | 通話品質評価テンプレートガジェットを配置する  |  
		2  |通話品質評価テンプレート番号   |   | ControlCenterで作成した通話品質評価テンプレートに割り当てられる番号です。1から作成した数だけ存在します。  |   
		3   |表示件数の選択   |  5 | UI上は5,10,20件だが、詳細設定では1~20件で設定可能  |    
		4  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		5   |対象期間   | 1  |UI上は今日のみ(1) 、昨日から(2)、過去7日（7）のみ。詳細設定では任意の数字で指定が可能   
		6   |ソート条件   | 1  |1:得点の高い順,2:得点の低い順
		7   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |  
		8  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |  
...
感情スコア識別名については[@tbl:emoscore]と[@tbl:emolist]を参照してください。
設定可能な値は 最大値(max),最小値（min）,平均値（ave）の3つです。【要確認】開始値と終了値も設定可能？
...
```
【要構成検討】デフォルトで定義されている感情：カラー：ラベル名の一覧の必要不要。
...
- 検索モジュール  
通話検索画面の UI です。『プロバイダ』 を組み合わせて構成します。（[@fig:provider]、[@fig:provider2]）  
...
#### 2-3-1. 通話検索に利用する検索モジュールのプロバイダ  
 ...
 1.  検索モジュールのプロバイダ設定  
	検索モジュールに利用するプロバイダは、ControlCenter 詳細設定の [@tbl:provider0] の項目を編集して構成します。  
		...
		3   |  attributes | 通話属性識別名        | 文字列 | 通話検索条件に追加する通話属性識別子です。通話属性識別名は CommunicationSuite 内で通話属性毎に設定されているユニークな識別名です。使用可能な通話属性については（[1-2-2. 通話表示機能　[@tbl:callb2] : OperatorAgent 表示する通話属性で利用可能な通話属性一覧](#1-2-2. 通話表示機能) 参照。）  を参照してください。  | ×|
		4   |  iconName | アイコン名        | 文字列| 検索プロバイダとして表示するアイコンを指定します。 表示可能なアイコンは[@tbl:icon1] から選択します。| 〇|
		5   |  lessQueryLabel | 入力文字数が少ないときに表示するラベル        |文字列| 通話検索条件入力欄にプレフィックスを入力した際に表示される説明文です。| 〇|
		6   |  iconLabel | アイコンのラベル        | 文字列|話検索入力欄のアイコンをマウスオーバーした時に表示される名称です。複数の通話検索条件で同じアイコン名を指定した場合、通話検索条件入力欄で該当のアイコンをマウスオーバーした際に表示されるのは設定順が上のものがアイコンラベルとなります。複数の通話検索条件で同じアイコン名を指定した場合、該当のアイコンをクリックすることで通話検索条件のアイコンラベルが複数表示されて選択クリックすることで任意の通話検索条件を選択することができます。| 〇|
		...
		![](images/Tips.jpg){width=50px}  
		追加した通話属性を１つにまとめる場合には同じアイコン名で書式を合わせます。  
...
AttributeCondition|prefixes=callid|attributes=amivoice.common.reference.local.id|lessQueryLabel=CALLIDの一部を入力してください...|iconName=tel1|iconLabel=CALLID
 ...
 5.  検索結果の並び順の設定  
		...
		並び順の設定はControlCenter 詳細設定の。 @tbl:narabi を編集して構成します。

		No. | 設定項目名       | 設定値 | 内容 |
		---:|------------------|--------------|------|
		1   |  SpeechVisualizer - 通話検索  | 検索で使用する並び順        | 検索で使用する並び順のキーのリストです。表示するキーを改行で区切ります。デフォルト設定のキーを削除すると、その項目はリストから表示されなくなります。 |

		: 検索で使用する並び順の設定 {#tbl:narabi}

		例） 並び順の設定例  
		キーのリストを改行で区切って登録します。上から記述した順番通りに並び順のリストが上から下に表示されます。  
...
複数の検索条件を組み合わせた場合は、常に and 条件となり、１つの検索条件内ではオプションを利用することができます。
 ...
 1.  検索条件のオプション  
		...
		No. |オプション     |検索条件| 説明
		---:|-----------------|----------|----------|
		1   | \"\,\"|  複数指定|1つの検索条件内で複数指定する場合の検索条件です。  
		2   |\"\-\" |  NOT 検索| 1つの検索条件内で指定したものを除外する検索条件です。  
		3   | \"or\"  | OR 検索|フリーワードで指定したキーワードのいずれかを対象とする検索条件です。  
		4   |\"空白\" |  AND 検索|フリーワードで指定した２つ以上のキーワードを対象とする検索条件です。空白は半角全角不問です。  

		: 検索条件のオプション {#tbl:narabi2}
 ...
 2. 検索条件ごとに利用可能なオプション  
	...
	No. |検索条件     | 複数指定| NOT 検索|OR 検索|AND 検索|備考|
	---:|-----------------|----------|----------|----------|----------|----------|
	1   | プロジェクト| 〇        |〇         | ×        | ×        |  
	2   | 通話の日付| ×      |×        |×         |×         |         |  
	3   | 時間|×        |×        |×         |×         |         |    
...
通話検索後の機能です。  
 ...
 2.  認識結果  
		...
		```
		いつもお世話になっております。アドバンストメディアでございます。  
		```
