...
#### 2-3-1. 利用可能な検索モジュールのプロバイダ
通話検索の検索条件として利用可能な検索モジュールのプロバイダ([@fig:provider])です。   
...
#### 2-3-3. 検索結果に表示する通話属性
検索結果に表示される通話に対して通話属性を追加で付与することが可能です。  
([@fig:kensakukekka])は検索結果に表示された通話に紐づいた通話属性です。

![通話に紐づいた通話属性](images/2-3-検索結果.png){#fig:kensakukekka width=６０0px}  
