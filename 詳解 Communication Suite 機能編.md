...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		:自分の通話ガジェットの設定項目 {#tbl:svhomemyrecent}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		6   |設定なし   |   |【要確認】
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:自分の通話(IN)ガジェットの設定項目 {#tbl:svhomemyrecentinbound}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		6   |設定なし   |   |【要確認】
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:自分の通話(OUT)ガジェットの設定項目 {#tbl:svhomemyrecentoutbound}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:所属プロジェクトの通話の設定項目 {#tbl:svhomeprojectrecent}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		6   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示   |  
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:所属プロジェクトの通話(IN)の設定項目 {#tbl:svhomeprojectrecentInbound}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		6   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示   |  
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |   
		:所属プロジェクト(OUT)の通話の設定項目 {#tbl:svhomeprojectrecentoutbound}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		6   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |  
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |  
		:自分が最近再生した通話の設定項目 {#tbl:svhomemyrecentplayhistory}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
	...
	[@tbl:svhomemyrecentviewhistory] はレイアウト配置設定項目です。
		...
		6   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示  |  
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |  
		:自分が最近参照した通話の設定項目 {#tbl:svhomemyrecentviewhistory}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		6   |カラム表示設定   |1|1:オペレータ名で表示,2:内線番号で表示 |  
		7  |感情解析結果の表示   | 1  |0:表示しない,1:表示する   |  
		:自分が最近編集した通話の設定項目 {#tbl:svhomemyrecentedithistory}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		3  |自動更新の有効化   | 0  |0:無効化,1:有効化   |     
		4   |設定なし   ||【要確認】|   
		:自分の通話に対する最近のコメントの設定項目 {#tbl:svhomerecentcomment}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		:自分が最近参照した通話の設定項目 {#tbl:svhomerecentpostcomment}
...
ユーザ個人設定の『ホーム画面のレイアウト』での書式設定は以下です。
		...
		```
		RatingCurve:"表示する横軸スケール(数値)":"表示する横軸スケール(単位)":"ガジェットの大きさ""
		```
		...
		2   |表示する横軸スケール(数値)   |6|UIで選択した場合は5,6,7,10,12,14のいずれかになります。詳細設定では任意の数字を指定が可能 |   
		3  |表示する横軸スケール(単位)   | M  |D:日,W:週,M:月    |  
		4  |  ガジェットの大きさ | 1  |1:狭い,2:普通,3:広い   |  
		:評価の遷移の設定項目 {#tbl:svhomeratingcurve}

		![](images/Tips.jpg){width=50px}　『評価の遷移』で扱う「評価」は通話詳細からのコメント時に設定できる星の数です。通話品質評価とは別の観点になります。
