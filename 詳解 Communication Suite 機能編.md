...
#### 2-3-1. 検索モジュールの通話プロバイダ
通話検索の画面で検索条件として利用可能な検索モジュールのプロバイダ([@fig:provider])が表示されます。   
検索モジュールのプロバイダは ContorlCenter の詳細設定( [@tbl:provider0])より追加・削除することが可能です。  
...
**表示する検索モジュールのプロバイダに通話属性を追加することが可能です。    
...
<br>
**番号系の通話属性を検索条件に追加する場合は、電話番号のプロバイダ名 \"TelCondition" に属性 ([@tbl:zokuseikey] ) を書式に合わせて追加してください。**  
...
: 追加可能な属性一覧 {#tbl:zokuseikey}


#### 2-3-2. 通話検索の条件
あああ
#### 2-3-3. 検索結果に表示可能な通話属性
あああ
